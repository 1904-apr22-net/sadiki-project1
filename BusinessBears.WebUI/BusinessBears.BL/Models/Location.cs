...
namespace BusinessBears.Library
{
    ...
    public class Location
    {
        ...
        //        {
        //            if (inventory.Find(x => x.Product.Name == item2.Name) != null)
        //            {
        //                if (inventory.Find(x => x.Product.Name == item2.Name).Quantity == 0)
        //                {
        //                    upgradesQ = false;
        //                }
        //            }
        ...
        //            {
        //                inventory.Find(x => x.Product.Name == item.Name).Quantity--;
        //            }
